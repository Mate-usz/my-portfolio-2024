  ...
  return (
    <main className="min-h-screen text-white overflow-x-hidden">
      ...
      <a
        ...
        className="fixed bottom-6 right-4 md:right-6 z-50 flex items-center gap-2 bg-green-500 hover:bg-green-600 transition text-white font-semibold px-3 py-3 md:px-4 rounded-full shadow-xl"
      >
        <svg
